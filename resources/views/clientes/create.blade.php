...
@section('content')
<div class="container">
    <h1 class="mb-4 fw-bold text-dark">➕ Crear Nuevo Cliente</h1>

    <form action="{{ route('clientes.store') }}" method="POST" class="card p-4 shadow-sm border-0 bg-white">
        @csrf
        ...
        <div class="d-flex justify-content-end">
            <button type="submit" class="btn text-white me-2" style="background-color: #7B2C32;">Guardar</button>
